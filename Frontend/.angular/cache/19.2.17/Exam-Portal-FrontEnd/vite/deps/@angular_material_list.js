...
MatList.ɵfac = function MatList_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatList)(ɵɵdirectiveInject(ElementRef));
};
...
MatListAvatarCssMatStyler.ɵfac = function MatListAvatarCssMatStyler_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatListAvatarCssMatStyler)();
};
...
MatListIconCssMatStyler.ɵfac = function MatListIconCssMatStyler_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatListIconCssMatStyler)();
};
...
MatListSubheaderCssMatStyler.ɵfac = function MatListSubheaderCssMatStyler_Factory(__ngFactoryType__) {
...
MatListItem.ɵfac = function MatListItem_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatListItem)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_NAV_LIST, 8), ɵɵdirectiveInject(MAT_LIST, 8));
};
...
MatListOption.ɵfac = function MatListOption_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatListOption)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(forwardRef(() => MatSelectionList)));
};
...
MatSelectionList.ɵfac = function MatSelectionList_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatSelectionList)(ɵɵdirectiveInject(ElementRef), ɵɵinjectAttribute("tabindex"), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(FocusMonitor));
};
...
MatListModule.ɵfac = function MatListModule_Factory(__ngFactoryType__) {
