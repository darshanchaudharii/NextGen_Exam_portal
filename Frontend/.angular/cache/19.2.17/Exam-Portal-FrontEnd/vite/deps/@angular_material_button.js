...
MatButton.ɵfac = function MatButton_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatButton)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusMonitor), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8));
};
...
MatAnchor.ɵfac = function MatAnchor_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatAnchor)(ɵɵdirectiveInject(FocusMonitor), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8), ɵɵdirectiveInject(NgZone, 8));
};
...
MatButtonModule.ɵfac = function MatButtonModule_Factory(__ngFactoryType__) {
